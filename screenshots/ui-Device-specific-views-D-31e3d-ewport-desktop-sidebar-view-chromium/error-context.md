...
- Location: /Users/freedommarketing/Desktop/effort-flow-planner/tests/ui.spec.ts:588:9
...
Call log:
  ...
  - 268 pixels (ratio 0.01 of all image pixels) are different.
    ...
    at /Users/freedommarketing/Desktop/effort-flow-planner/tests/ui.spec.ts:593:32
```
...
```ts
  493 |                     page.locator('[data-testid="task-form"]'),
  494 |                 ];
  495 |
  496 |                 let dialogVisible = false;
  497 |                 let dialogDetails = '';
  498 |
  499 |                 for (const dialog of dialogSelectors) {
  500 |                     if (
  501 |                         (await dialog.count()) > 0 &&
  502 |                         (await dialog.isVisible())
  503 |                     ) {
