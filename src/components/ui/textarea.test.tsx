...
describe('Textarea Component', () => {
  it('should render the Tiptap editor', () => {
    render(<Textarea value="" onChange={() => {}} data-testid="tiptap-editor" />);
  ...
  it('should call onChange with HTML content when text is typed', async () => {
    ...
    render(<Textarea value="" onChange={handleChange} data-testid="tiptap-editor" />);
    const editorElement = screen.getByTestId('tiptap-editor');
  ...
  it('should call onTiptapKeyDown when a key is pressed', () => {
    ...
    render(<Textarea value="" onChange={() => {}} onTiptapKeyDown={handleKeyDown} data-testid="tiptap-editor" />);
    const editorElement = screen.getByTestId('tiptap-editor');
  ...
  it('should update editor content when value prop changes (testing useEffect sync)', () => {
    const { rerender } = render(<Textarea value="<p>Initial</p>" onChange={() => {}} data-testid="tiptap-editor" />);
    const editorElement = screen.getByTestId('tiptap-editor');
    expect(editorElement).toContainHTML('<p>Initial</p>');

    rerender(<Textarea value="<p>Updated</p>" onChange={() => {}} data-testid="tiptap-editor" />);
