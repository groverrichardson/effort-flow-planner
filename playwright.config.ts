...
export default defineConfig({
    ...
    projects: [
        ...
        },
        {
            ...
            use: {
                ...
                baseURL: `http://localhost:${process.env.TEST_PORT || '8081'}`,
    ...
    webServer: {
        ...
        command: `VITE_PORT=${process.env.TEST_PORT || '8081'} npm run dev`,
        url: `http://localhost:${process.env.TEST_PORT || '8081'}`,
